...
export default function Products() {
  ...
  const proteins = allProducts[2].protein;
  const creatines = allProducts[1].creatine;
  const others = allProducts[3].others;
  const preWorkouts = allProducts[0].preWorkout;

  return (
    <section className="flex flex-col px-4 lg:px-6 xl:px-32 py-2" id="Produtos">
      <h2 className="font-bold text-xl my-3 border-b-2 border-secondary w-fit text-primary">
        Proteínas
      </h2>
